...
namespace SignalRApiForSql.Models
{
    public class VisitorService
    {
        ...
        public List<VisitorChart> GetVisitorChartList()
        {
            ...
            {
                Command.CommandText = "select tarih,[1],[2],[3],[4],[5] from (select[City],CityVisitCount,Cast([VisitDate]as Date) as tarih from " +
                    "Visitors) as visitTable Pivot (sum(CityVisitCount) for City in ([1],[2],[3],[4],[5]))as pivottable\r\norder by tarih asc";
